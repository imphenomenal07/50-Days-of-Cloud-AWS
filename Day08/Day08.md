...
AWS Console > Search 'EC2' > Open EC2 Dashbaord > Instances > Select the running isntance > Actions > Instance Settings > Change Stop Protection > Click on 'Enabled' > Save
